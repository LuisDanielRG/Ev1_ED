    ...
    def ConsultaPorPeriodo():
        ...
        while True:
            while True:
                ...
                fecha_capturadaInicial = input("\nIngresa la fecha de inicio (dd/mm/yyyy) o precione Enter para usar la fecha predefinida (01/01/2000):  ")
                if fecha_capturadaInicial == "":
                  fecha_inicial = datetime.date(2000, 1, 1)
                  print("se uso la fecha predefinida (01/01/2000)")
                break
            try:    
             return datetime.datetime.strptime(fecha_capturadaInicial, "%d/%m/%Y").date()
             break
            except ValueError:
            ...
            while True:
                ...
                fecha_capturadaFinal = input("\nIngresa la fecha final (dd/mm/yyyy) o precione Enter para usar la fecha actual: ")
