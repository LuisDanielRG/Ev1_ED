def BaseDeDatos():
    ...
    try:
        with sqlite3.connect("TallerMecanico.db") as conn:
            ...
            cursor.execute("CREATE TABLE IF NOT EXISTS Servicios (Clave INTEGER PRIMARY KEY, Nombre TEXT NOT NULL, Costo REAL NOT NULL);")
        ...
        try:
            with sqlite3.connect("TallerMecanico.db") as conn:
                ...
                if clientes_registrados:
                    # Muestra los clientes registrados anteriormente.
                    ...
                    while True:
                        ...
                        if cliente_clave.strip() == "":
                            ...
                            try:
                                ...
                                # Verifica si el cliente ya ha sido registrado.
                                if cliente is None:
                ...
                if servicios_registrados:
                    ...
                    detalle_nota = [] # Lista para almacenar los servicios de cada nota.
                    while True:
                        ...
                        if servicio_clave.strip() == "":
                            ...
                            try:
                                ...
                                # Verifica si el servicio ya ha sido registrado.
                                if servicio is None:
    ...
    def AgregarServicio():
        ...
        while True:
            ...
            try:
                with sqlite3.connect("TallerMecanico.db") as conn:
                    cursor = conn.cursor()
                    datos_servicios = (nombre_servicio, costo_servicio)
                    cursor.execute("INSERT INTO Servicios (Nombre, Costo) VALUES (?,?)", datos_servicios)
