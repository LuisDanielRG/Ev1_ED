    ...
    def CancelarNota():
        try:
            with sqlite3.connect("TallerMecanico.db") as conn:
                ...
                if not detalle_nota:
                    print("[dark_orange]*** La nota no se encuentra en el sistema. ***[/dark_orange]")
                else:
        ...
        def ConsultaPorPeriodo():
            try:
                with sqlite3.connect("TallerMecanico.db") as conn:
                    ...
                    promedio_montos = cursor.fetchone()
                    ...
                    if not notas_periodo:
                        ...
                        promedio_montos_fila = ["", "", "", "", f"PROMEDIO: {promedio_montos[0]:.2f}"]
                        notas_periodo.append(promedio_montos_fila)
                        
                        print(f"\n[bold light_pink1]{('REPORTE DE NOTAS POR PERÍODO').center(80)}[/bold light_pink1]")
                        ...
                        while True:
                            ...
                            if opcion_exportar == 1:
                                archivo_csv = f"ReportePorPeriodo_{fecha_inicial.strftime('%d_%m_%Y')}_{fecha_final.strftime('%d_%m_%Y')}.csv"
                                ...
                                archivo_excel = f"ReportePorPeriodo_{fecha_inicial.strftime('%d_%m_%Y')}_{fecha_final.strftime('%d_%m_%Y')}.xlsx"
        ...
        try:
            with sqlite3.connect("TallerMecanico.db") as conn:
                ...
                if not clientes_activos:
                    ...
                    encabezado = ["CLAVE", "NOMBRE"]
                    print(f"\n[bold light_pink1]{('CLIENTES ACTIVOS').center(30)}[/bold light_pink1]")
                    print(tabulate(clientes_activos, encabezado, tablefmt="grid"))
        ...
        try:
            with sqlite3.connect("TallerMecanico.db") as conn:
                ...
                if not clientes_suspendidos:
                    ...
                    encabezado = ["CLAVE", "NOMBRE"]
                    print(f"\n[bold light_pink1]{('CLIENTES SUSPENDIDOS').center(25)}[/bold light_pink1]")
                ...
                try:
                    with sqlite3.connect("TallerMecanico.db") as conn:
                        ...
                        while True:    
                            ...
                            fecha_actual = datetime.datetime.today().strftime("%d_%m_%Y")
                            if opcion_exportar == 1:
        ...
        def BusquedaClaveCliente():
            try:
                with sqlite3.connect("TallerMecanico.db") as conn:
                    ...
                    if datos_clientes:
                        encabezado = ["CLAVE", "NOMBRE"]
                        reporte_clientes = tabulate(datos_clientes, encabezado, tablefmt="grid")
                        print(f"\n[bold light_pink1]  CLIENTES ACTIVOS REGISTRADOS  [/bold light_pink1]")
                            ...
                            if clave.strip() == "":
                                ...
                                try:
                                    ...
                                    if datos_clave:
                                        ...
                                        print(f"\n[bold light_pink1]{('DETALLE DE CLIENTE ACTIVO CON LA CLAVE ' + str(clave_cliente)).center(65)}[/bold light_pink1]")
                                        print(reporte_clave)
                                        break
                                    else:
                                        print("[red]*** ¡ERROR! La clave ingresada aún no ha sido registrada o ya ha sido suspendida. ***[/red]")
                                except ValueError:
                                    print("[red]*** ¡ERROR! La clave debe ser un número entero. ***[/red]")
                    else:
                        print(f"[red]*** No se encontró ningún cliente activo. ***[/red]")
            except Error as error:
                print(f"[red]*** {error} ***[/red]")
            except Exception:
                print(f"[red]*** Ha ocurrido el siguiente error: {sys.exc_info()[0]} ***[/red]")
            ...
            try:
                with sqlite3.connect("TallerMecanico.db") as conn:
                    ...
                    if datos_consulta_nombre:
                        ...
                        print(f"\n[bold light_pink1]{('BÚSQUEDA DE CLIENTES ACTIVOS CON EL NOMBRE ' + nombre_consulta.upper()).center(65)}[/bold light_pink1]")
        ...
        try:
            with sqlite3.connect("TallerMecanico.db") as conn:
                ...
                if not servicios_activos:
                    ...
                    encabezado = ["CLAVE", "NOMBRE"]
                    print(f"\n[bold light_pink1]{('SERVICIOS ACTIVOS').center(30)}[/bold light_pink1]")
                    print(tabulate(servicios_activos, encabezado, tablefmt="grid"))
        ...
        try:
            with sqlite3.connect("TallerMecanico.db") as conn:
                ...
                if not servicios_suspendidos:
                    ...
                    encabezado = ["CLAVE", "NOMBRE"]
                    print(f"\n[bold light_pink1]{('SERVICIOS SUSPENDIDOS').center(30)}[/bold light_pink1]")
                    ...
                    if datos_servicios:
                        ...
                        while True:
                            ...
                            if clave.strip() == "":
                                ...
                                try:
                                    clave_servicio= int(clave)
                                    dato = {"clave":clave_servicio}
                                    ...
                                    if datos_clave:
                                        encabezado = ["CLAVE", "NOMBRE", "COSTO"]
                                        reporte_clave = tabulate(datos_clave, encabezado, tablefmt="grid")
                                        print(f"\n[bold light_pink1]DETALLE DEL SERVICIO ACTIVO CON LA CLAVE {clave_servicio}[/bold light_pink1]")
                                        print(reporte_clave)
                                        break
                                    else:
                                        print("[red]*** ¡ERROR! La clave ingresada aún no ha sido registrada o ya ha sido suspendida. ***[/red]")
    ...
    def ServiciosMasPrestados():
        try:
            with sqlite3.connect("TallerMecanico.db") as conn:
                ...
                while True:
                    cantidad_servicios = input("\nIngrese la cantidad de servicios más prestados a identificar: ")
                    if cantidad_servicios.strip() == "":
                        print("[red]*** ¡ERROR! No puede quedar vacío. ***[/red]")
                    else:
                        try:
                ...
                if not servicios_mas_prestados:
                    ...
                    encabezado = ["NOMBRE DEL SERVICIO", "CANTIDAD DE VECES"]
                    print(f"\n[bold light_pink1]{('SERVICIOS MÁS PRESTADOS').center(50)}[/bold light_pink1]")
                    print(tabulate(servicios_mas_prestados, encabezado, tablefmt="grid"))

                    while True:
                        opcion_exportar = MenuExportacion()

                        if opcion_exportar == 1:
                            archivo_csv = f"ReporteServiciosMasPrestados_{fecha_inicial.strftime('%d_%m_%Y')}_{fecha_final.strftime('%d_%m_%Y')}.csv"
                            ExportarDatos(servicios_mas_prestados, archivo_csv, encabezado=encabezado)
                            print(f"\n[green]*** Información exportada correctamente con el nombre [u]{archivo_csv}[/u] ***[/green]")
                        elif opcion_exportar == 2:
                            archivo_excel = f"ReporteServiciosMasPrestados_{fecha_inicial.strftime('%d_%m_%Y')}_{fecha_final.strftime('%d_%m_%Y')}.xlsx"
                            ExportarDatos(servicios_mas_prestados, archivo_excel, encabezado=encabezado)
                            print(f"\n[green]*** Información exportada correctamente con el nombre [u]{archivo_excel}[/u] ***[/green]")
                        elif opcion_exportar == 3:
                            print("[yellow]Volviendo al menú anterior...[/yellow]")
                            return           
        ...
        try:
            with sqlite3.connect("TallerMecanico.db") as conn:
                ...
                if not clientes_mas_notas:
                    ...
                    print(f"\n[bold light_pink1]{('CLIENTES CON MÁS NOTAS').center(60)}[/bold light_pink1]")
                    ...
                    while True:
                        ...
                        if opcion_exportar == 1:
                            archivo_csv = f"ReporteClientesConMasNotas_{fecha_inicial.strftime('%d_%m_%Y')}_{fecha_final.strftime('%d_%m_%Y')}.csv"
                            ExportarDatos(clientes_mas_notas, archivo_csv, encabezado=encabezado)
                            print(f"\n[green]*** Información exportada correctamente con el nombre [u]{archivo_csv}[/u] ***[/green]")
                        elif opcion_exportar == 2:
                            archivo_excel = f"ReporteClientesConMasNotas_{fecha_inicial.strftime('%d_%m_%Y')}_{fecha_final.strftime('%d_%m_%Y')}.xlsx"
    ...
    def PromedioMontos():
        try:
            with sqlite3.connect("TallerMecanico.db") as conn:
                ...
                if promedio_montos is None:
                    print(f"[dark_orange]*** No se encontraron notas para el período específicado. ***[/dark_orange]")
                else:
                    print(f"\n[bold green]El monto promedio para las notas para el período {fecha_inicial.strftime('%d/%m/%Y')} - {fecha_final.strftime('%d/%m/%Y')} es: ${promedio_montos[0]:.2f}[/bold green]")
        except Error as error:
            print(f"[red]*** {error} ***[/red]")
        except Exception:
            print(f"[red]*** Ha ocurrido el siguiente error: {sys.exc_info()[0]} ***[/red]")
